...
function goodTime(str){
	...
	var now = new Date().getTime(),//返回1970年1月1日至今的毫秒数
		oldTime = new Date(str).getTime(),//返回1970年1月1日至某一个日期的毫秒数
...
//时间整形
/*function fetGoodTime(str){
	// "2016-05-31T08:33:21.950Z"时间格式
	var now=new Date().getTime(),
	    oldTime=new Date(str).getTime(),
	    shortOfTime=now-oldTime,
	    result="",
	    minute=1000*60,
	    hour=minute*60,
	    date=hour*24,
	    ...
	    _year=shortOfTime/year,
	    _month=shortOfTime/month,
	    _date=shortOfTime/date,
	    _hour=shortOfTime/hour,
	    _minute=shortOfTime/minute,
